...
namespace Antilli
{
    public sealed class ObjFile
    {
        ...
        public sealed class ObjMaterial
        {
            ...
            private void SetColorAndMap(string colorKey, string mapKey, Color color, string map)
            {
            ...
            public void SetComponent(ComponentType componentType, Color color, string map = null)
            {
        ...
        public sealed class ObjMesh
        {
            ...
            public ObjMesh(ObjGroup group, ObjMaterial material) : this(group)
            {
                Material = material;
            }
        }
        ...
        private void GetKeyVal(string line, out string key, out string val)
        {
            ...
            val = String.Join("", line.Split(new[] { key }, StringSplitOptions.None));
                    ...
                    case "s":
                        {
                            ...
                            {
                                CurrentMesh = CurrentMesh.Split(sg);
                            }
                        } break;
                    case "usemtl":
                        {
